# Generated by Django 3.0 on 2019-12-17 09:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[(1, 'register'), (2, 'forget'), (3, 'change')], max_length=10, verbose_name='验证码类型')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.DateField(choices=[('girl', '女'), ('boy', '男')], default='girl', max_length=10, verbose_name='用户性别')),
