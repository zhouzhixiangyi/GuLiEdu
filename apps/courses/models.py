...
class CourseInfo(models.Model):
    ...
    teacher_info = models.ForeignKey(TeacherInfo, verbose_name='所属教师', on_delete=models.CASCADE)
...
class SourceInfo(models.Model):
    ...
    download = models.FileField(upload_to='source/', max_length=200, verbose_name='下载路径')
    course_info = models.ForeignKey(CourseInfo, verbose_name='所属课程', on_delete=models.CASCADE)
    add_time = models.DateTimeField(default=datetime.now, verbose_name='添加时间')
